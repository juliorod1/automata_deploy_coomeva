...
ATTACHMENT_NAME="log_ejecucion_$id_cambio.log"
ATTACHMENT_FILE="/home/deployuser/logs/log_ejecucion_$id_cambio.log"
...
echo "To: ${lista_mail}"
echo "Subject: ${asunto_final}"
echo ""
echo "--SEP-BOUNDARY"
echo "Content-Type: text/plain; charset=UTF-8"
echo ""
echo "${cuerpo_mensaje_final}"
echo ""
...
echo ""
echo "$(base64 "$ATTACHMENT_FILE")"
echo "--SEP-BOUNDARY--"
)| /usr/sbin/sendmail -oi -f "$sender_email" "$lista_mail"
}
{% endraw %}
#############################################################################################
